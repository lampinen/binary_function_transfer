...
optimizer = "Adam"
num_runs = 500
directory_format = "results_moretask_generalization_nonbinary_scales_%s_stb_nt2_%i_gthl_%i_gtb_%i_nse_4400_nte_800_nl_%i_nh_%i_lr_%.4f_im_%.2f/"
...
#ggsave("plots/nonbinary_min_gen_difference_iso_noniso.png", width=9, height=6)
```
